...
bool utils__msg__lantern_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("utils.msg._lantern_pose.LanternPose", full_classname_dest, 35) == 0);
  }
  utils__msg__LanternPose * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of LanternPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("utils.msg._lantern_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LanternPose");
