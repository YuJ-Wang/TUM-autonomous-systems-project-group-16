...
bool statemachine_pkg__msg__command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("statemachine_pkg.msg._command.Command", full_classname_dest, 37) == 0);
  }
  statemachine_pkg__msg__Command * ros_message = _ros_message;
  {  // target
...
PyObject * statemachine_pkg__msg__command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("statemachine_pkg.msg._command");
