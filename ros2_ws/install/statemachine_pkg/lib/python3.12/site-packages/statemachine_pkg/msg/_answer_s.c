...
bool statemachine_pkg__msg__answer__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("statemachine_pkg.msg._answer.Answer", full_classname_dest, 35) == 0);
  }
  statemachine_pkg__msg__Answer * ros_message = _ros_message;
  {  // node_name
...
PyObject * statemachine_pkg__msg__answer__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("statemachine_pkg.msg._answer");
