...
#define NODE_MAIN_LOGGER_NAME "lantern_detector"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblantern_detector_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<lantern_detector::LanternDetectorNode>";
