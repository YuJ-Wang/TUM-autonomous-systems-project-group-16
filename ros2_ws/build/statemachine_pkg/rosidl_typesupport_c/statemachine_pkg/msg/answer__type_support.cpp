...
static const _Answer_type_support_symbol_names_t _Answer_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, statemachine_pkg, msg, Answer)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, statemachine_pkg, msg, Answer)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, statemachine_pkg, msg, Answer)() {
  return &::statemachine_pkg::msg::rosidl_typesupport_c::Answer_message_type_support_handle;
}
