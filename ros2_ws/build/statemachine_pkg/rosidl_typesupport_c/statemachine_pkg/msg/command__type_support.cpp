...
static const _Command_type_support_symbol_names_t _Command_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, statemachine_pkg, msg, Command)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, statemachine_pkg, msg, Command)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, statemachine_pkg, msg, Command)() {
  return &::statemachine_pkg::msg::rosidl_typesupport_c::Command_message_type_support_handle;
}
