...
#include "statemachine_pkg/msg/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = statemachine_pkg::msg::Command;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const statemachine_pkg::msg::Command *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<statemachine_pkg::msg::Command *>(
    untyped_ros_message);
...
{
  return &statemachine_pkg::msg::typesupport_fastrtps_cpp::_Command__handle;
}
