...
static const _Command_type_support_symbol_names_t _Command_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, statemachine_pkg, msg, Command)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, statemachine_pkg, msg, Command)),
  }
};
...
{
  return &::statemachine_pkg::msg::rosidl_typesupport_cpp::Command_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, statemachine_pkg, msg, Command)() {
  return get_message_type_support_handle<statemachine_pkg::msg::Command>();
}
