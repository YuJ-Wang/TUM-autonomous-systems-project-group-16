...
{
  new (message_memory) utils::srv::SaveMap_Request(_init);
}

void SaveMap_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<utils::srv::SaveMap_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SaveMap_Request_message_member_array[1] = {
  {
    ...
    offsetof(utils::srv::SaveMap_Request, file_path),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SaveMap_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(utils::srv::SaveMap_Request),
...
get_message_type_support_handle<utils::srv::SaveMap_Request>()
{
  return &::utils::srv::rosidl_typesupport_introspection_cpp::SaveMap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, utils, srv, SaveMap_Request)() {
  return &::utils::srv::rosidl_typesupport_introspection_cpp::SaveMap_Request_message_type_support_handle;
}
...
void SaveMap_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) utils::srv::SaveMap_Response(_init);
}

void SaveMap_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<utils::srv::SaveMap_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SaveMap_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(utils::srv::SaveMap_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(utils::srv::SaveMap_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SaveMap_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(utils::srv::SaveMap_Response),
  false,  // has_any_key_member_
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<utils::srv::SaveMap_Response>()
{
  return &::utils::srv::rosidl_typesupport_introspection_cpp::SaveMap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, utils, srv, SaveMap_Response)() {
  return &::utils::srv::rosidl_typesupport_introspection_cpp::SaveMap_Response_message_type_support_handle;
}
...
void SaveMap_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) utils::srv::SaveMap_Event(_init);
}

void SaveMap_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<utils::srv::SaveMap_Event *>(message_memory);
  typed_message->~SaveMap_Event();
}

size_t size_function__SaveMap_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<utils::srv::SaveMap_Request> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<utils::srv::SaveMap_Request> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<utils::srv::SaveMap_Request> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const utils::srv::SaveMap_Request *>(
    get_const_function__SaveMap_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<utils::srv::SaveMap_Request *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<utils::srv::SaveMap_Request *>(
    get_function__SaveMap_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const utils::srv::SaveMap_Request *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<utils::srv::SaveMap_Response> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<utils::srv::SaveMap_Response> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<utils::srv::SaveMap_Response> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__SaveMap_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const utils::srv::SaveMap_Response *>(
    get_const_function__SaveMap_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<utils::srv::SaveMap_Response *>(untyped_value);
  value = item;
}
...
void assign_function__SaveMap_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<utils::srv::SaveMap_Response *>(
    get_function__SaveMap_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const utils::srv::SaveMap_Response *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SaveMap_Event_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(utils::srv::SaveMap_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<utils::srv::SaveMap_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(utils::srv::SaveMap_Event, request),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<utils::srv::SaveMap_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(utils::srv::SaveMap_Event, response),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SaveMap_Event_message_members = {
  ...
  3,  // number of fields
  sizeof(utils::srv::SaveMap_Event),
  false,  // has_any_key_member_
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<utils::srv::SaveMap_Event>()
{
  return &::utils::srv::rosidl_typesupport_introspection_cpp::SaveMap_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, utils, srv, SaveMap_Event)() {
  return &::utils::srv::rosidl_typesupport_introspection_cpp::SaveMap_Event_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SaveMap_service_members = {
  ...
  // see get_service_type_support_handle<utils::srv::SaveMap>()
...
static const rosidl_service_type_support_t SaveMap_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<utils::srv::SaveMap_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<utils::srv::SaveMap_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<utils::srv::SaveMap_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<utils::srv::SaveMap>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<utils::srv::SaveMap>,
...
get_service_type_support_handle<utils::srv::SaveMap>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::utils::srv::rosidl_typesupport_introspection_cpp::SaveMap_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, utils, srv, SaveMap)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<utils::srv::SaveMap>();
}
