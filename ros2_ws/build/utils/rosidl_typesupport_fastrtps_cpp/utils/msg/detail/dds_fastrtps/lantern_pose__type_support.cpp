...
#include "utils/msg/detail/lantern_pose__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = utils::msg::LanternPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const utils::msg::LanternPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<utils::msg::LanternPose *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LanternPose__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const utils::msg::LanternPose *>(
...
static size_t _LanternPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LanternPose(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LanternPose__callbacks = {
  "utils::msg",
  "LanternPose",
...
static rosidl_message_type_support_t _LanternPose__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LanternPose__callbacks,
...
get_message_type_support_handle<utils::msg::LanternPose>()
{
  return &utils::msg::typesupport_fastrtps_cpp::_LanternPose__handle;
}
