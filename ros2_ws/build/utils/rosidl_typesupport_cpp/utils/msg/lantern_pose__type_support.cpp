...
static const _LanternPose_type_support_symbol_names_t _LanternPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, utils, msg, LanternPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, utils, msg, LanternPose)),
  }
};
...
{
  return &::utils::msg::rosidl_typesupport_cpp::LanternPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, utils, msg, LanternPose)() {
  return get_message_type_support_handle<utils::msg::LanternPose>();
}
