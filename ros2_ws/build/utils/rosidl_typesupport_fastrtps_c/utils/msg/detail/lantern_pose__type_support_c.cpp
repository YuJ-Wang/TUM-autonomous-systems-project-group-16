...
#include "utils/msg/detail/lantern_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // source_frame
#include "rosidl_runtime_c/string_functions.h"  // source_frame
...
using _LanternPose__ros_msg_type = utils__msg__LanternPose;
...
size_t get_serialized_size_utils__msg__LanternPose(
  ...
  size_t current_alignment)
{
  const _LanternPose__ros_msg_type * ros_message = static_cast<const _LanternPose__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = utils__msg__LanternPose;
    is_plain =
      (
      offsetof(DataType, source_frame) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
...
static bool _LanternPose__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const utils__msg__LanternPose * ros_message = static_cast<const utils__msg__LanternPose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_utils__msg__LanternPose(ros_message, cdr);
}

static bool _LanternPose__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  utils__msg__LanternPose * ros_message = static_cast<utils__msg__LanternPose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_utils__msg__LanternPose(cdr, ros_message);
}

static uint32_t _LanternPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_utils__msg__LanternPose(
      untyped_ros_message, 0));
}

static size_t _LanternPose__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_utils__msg__LanternPose(
...
static message_type_support_callbacks_t __callbacks_LanternPose = {
  "utils::msg",
  "LanternPose",
  _LanternPose__cdr_serialize,
  _LanternPose__cdr_deserialize,
  _LanternPose__get_serialized_size,
  _LanternPose__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _LanternPose__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LanternPose,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, utils, msg, LanternPose)() {
  return &_LanternPose__type_support;
}
