...
private:
  ...
  void on_frontier_goal(const geometry_msgs::msg::Point::SharedPtr msg);
  ...
  nav_msgs::msg::Path build_straight_line_path(
    const geometry_msgs::msg::PoseStamped & goal) const;
  void publish_path_to_goal(const geometry_msgs::msg::PoseStamped & goal);

  rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr odom_sub_;
  rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr goal_sub_;
  rclcpp::Subscription<geometry_msgs::msg::Point>::SharedPtr frontier_goal_sub_;
